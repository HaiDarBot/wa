...
*/
const A187 = 'DAR'; // JANGAN UBAH-UBAH INFO!!!
const instagram = 'https://instagram.com/oni_15__'; // JANGAN UBAH-UBAH INFO!!!
const nomer = 'Wa.me/+6289673762275'; // JANGAN UBAH-UBAH INFO!!!
const aktif = 'Tergantung jaringan'; // JANGAN UBAH-UBAH INFO!!!
const groupwhatsapp = 'https://chat.whatsapp.com/D2D8g0Wt6xwA1D45gKTAUU'; // JANGAN UBAH-UBAH INFO!!!
...
conn.on('user-presence-update', json => console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @oni_15__.ig`))
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @oni_15__.ig`)
})
